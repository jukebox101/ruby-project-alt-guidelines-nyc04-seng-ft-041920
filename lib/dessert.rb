class Dessert < ActiveRecord::Base
    ...
    def self.dessert_selection(customer_name)
        @@prompt.select("What type of dessert would you like?".colorize(:yellow)) do |menu|
    ...
    def self.cakes(customer_name)
        new_dessert = nil
        @@prompt.select("What kind of cake would you like?".colorize(:yellow)) do |menu|
    ...
    def self.pies(customer_name)
        new_dessert = nil
        @@prompt.select("What kind of pie would you like?".colorize(:yellow)) do |menu|
    ...
    def self.cookies(customer_name)
        new_dessert = nil
        @@prompt.select("What kind of cookie would you like?".colorize(:yellow)) do |menu|
    ...
    def self.pastries(customer_name)
        new_dessert = nil
        @@prompt.select("What kind of pastries would you like?".colorize(:yellow)) do |menu|
    ...
    def self.macarons(customer_name)
        new_dessert = nil
        @@prompt.select("What kind of macaron would you like?".colorize(:yellow)) do |menu|
    ...
    def self.ice_cream(customer_name)
        new_dessert = nil
        @@prompt.select("What kind of ice cream would you like?".colorize(:yellow)) do |menu|
    ...
    def self.select_dessert(customer_name)
        ...
        puts dessert_names
        answer = @@prompt.ask("Which dessert would you like to customize? Type in the order number:".colorize(:yellow)) do |q|
            q.required true
        end
        answer
    end
    ...
    def self.delete_an_item(customer_name)
        ...
        dess_id = @@prompt.ask("Which item would you like to delete? Type in the order number:".colorize(:yellow)) do |q|
            q.required true
        end
        ...
        if  Dessert.all.find {|d| d.id == dess_id}
            ...
            answer = @@prompt.select("Are you sure you want to delete Order ##{dess_id}?".colorize(:blue)) do |menu|
